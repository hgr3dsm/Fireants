...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Fireants developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Fireants"
...
#define PACKAGE_BUGREPORT "https://github.com/hgr3dsm"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Fireants"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Fireants 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "fireants"
